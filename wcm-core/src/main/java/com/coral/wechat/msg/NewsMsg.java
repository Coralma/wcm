...
public class NewsMsg extends BaseMsg {
     ...
     *
     * @param maxSize NewsMsg对象的Article最大条数，范围：1~10
     */
    ...
    public String toJson() {
        String json = "{\"touser\":\"" + this.getToUserName() + "\",\"msgtype\":\"news\",\"news\":{\"articles\": [";
        for (Article a : this.getArticles()) {
            json += "{\"title\":\"" + a.getTitle() + "\",";
            if (a.getUrl() != null) {
                json += "\"url\":\"" + a.getUrl() + "\",";
            }
            if (a.getPicUrl() != null) {
                json += "\"picurl\":\"" + a.getPicUrl() + "\",";
            }
